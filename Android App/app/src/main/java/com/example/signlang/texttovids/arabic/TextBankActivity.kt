...
class TextBankActivity : AppCompatActivity() {
    private lateinit var speechRecognizer:SpeechRecognizer
    private lateinit var binding: ActivityTextBankBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTextBankBinding.inflate(layoutInflater)
    ...
    private fun upload(word:String){
        try{
            ...
            jsonObject.put("cat", "arabic/Bank")
                ...
                override fun onResponse(call: Call<Output>, response: Response<Output>) {
                    if (response.isSuccessful) {
                        response.body()?.let {
                            ...
                            binding.videoPlayer.setMediaController(MediaController(this@TextBankActivity))
                            binding.videoPlayer.start()
