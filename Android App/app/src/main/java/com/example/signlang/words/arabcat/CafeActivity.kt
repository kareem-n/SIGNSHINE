...
import com.example.signlang.databinding.ActivityCafeBinding
...
//                }
    ...
    private fun upload(frames : List<String>){
        try{
            ...
            RetrofitConfig.getServiceInstance().fetchSignVideoCafe(Frames(json)).enqueue(object :
                Callback<Output> {
    ...
    private fun print(message :String){
        Toast.makeText(this@CafeActivity,message, Toast.LENGTH_LONG).show()
    }
    private fun timer(){
        CoroutineScope(Dispatchers.Default).launch {
