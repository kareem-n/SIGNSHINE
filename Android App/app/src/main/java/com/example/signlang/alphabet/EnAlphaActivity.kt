...
import com.example.signlang.databinding.ActivityEnAlphaBinding
...
class EnAlphaActivity : AppCompatActivity() {
    lateinit var tts: TextToSpeech
    private lateinit var binding: ActivityEnAlphaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEnAlphaBinding.inflate(layoutInflater)
...
//                }
    ...
    private fun print(message :String){
        Toast.makeText(this@EnAlphaActivity,message, Toast.LENGTH_LONG).show()
    }
    private fun upload(frames : List<String>){
        try{
            ...
            RetrofitConfig.getServiceInstance().fetchSignEnPic(Frames(json)).enqueue(object :
                Callback<Output> {
