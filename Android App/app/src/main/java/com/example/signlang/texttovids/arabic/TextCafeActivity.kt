...
import com.example.signlang.databinding.ActivityTextBankBinding
import com.example.signlang.databinding.ActivityTextCafeBinding
...
class TextCafeActivity : AppCompatActivity() {
    private lateinit var speechRecognizer: SpeechRecognizer
    private lateinit var binding: ActivityTextCafeBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTextCafeBinding.inflate(layoutInflater)
    ...
    private fun upload(word:String){
        try{
            ...
            jsonObject.put("cat", "arabic/Cafe")
                ...
                override fun onResponse(call: Call<Output>, response: Response<Output>) {
                    if (response.isSuccessful) {
                        response.body()?.let {
                            ...
                            binding.videoPlayer.setMediaController(MediaController(this@TextCafeActivity))
                            binding.videoPlayer.start()
