...
class TextHospActivity : AppCompatActivity() {
    private lateinit var speechRecognizer: SpeechRecognizer
    private lateinit var binding: ActivityTextHospBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTextHospBinding.inflate(layoutInflater)
    ...
    private fun upload(word: String) {
        try {
            ...
            jsonObject.put("cat", "arabic/Hospital")
                ...
                override fun onResponse(call: Call<Output>, response: Response<Output>) {
                    if (response.isSuccessful) {
                        response.body()?.let {
                            ...
                            binding.videoPlayer.setMediaController(MediaController(this@TextHospActivity))
                            binding.videoPlayer.start()
