...
import com.example.signlang.databinding.ActivityBankBinding
...
//                }
    ...
    private fun upload(frames : List<String>){
        try{
            ...
            RetrofitConfig.getServiceInstance().fetchSignVideoBank(Frames(json)).enqueue(object :
                Callback<Output> {
    ...
    private fun print(message :String){
        Toast.makeText(this@BankActivity,message, Toast.LENGTH_LONG).show()
    }
    private fun timer(){
        CoroutineScope(Dispatchers.Default).launch {
