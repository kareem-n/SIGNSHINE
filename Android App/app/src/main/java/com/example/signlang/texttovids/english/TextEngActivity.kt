package com.example.signlang.texttovids.english
...
import com.example.signlang.databinding.ActivityTextEngBinding
...
class TextEngActivity : AppCompatActivity() {
    private lateinit var binding: ActivityTextEngBinding
    private lateinit var speechRecognizer: SpeechRecognizer
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTextEngBinding.inflate(layoutInflater)
                ...
                override fun onResponse(call: Call<Output>, response: Response<Output>) {
                    if (response.isSuccessful) {
                        response.body()?.let {
                            ...
                            binding.videoPlayer.setMediaController(MediaController(this@TextEngActivity))
                            binding.videoPlayer.start()
