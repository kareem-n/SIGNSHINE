...
import com.example.signlang.databinding.ActivityAlphaTurBinding
...
class AlphaTurActivity : AppCompatActivity() {
    lateinit var tts: TextToSpeech
    private lateinit var binding: ActivityAlphaTurBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAlphaTurBinding.inflate(layoutInflater)
...
//                }
    ...
    private fun print(message :String){
        Toast.makeText(this@AlphaTurActivity,message, Toast.LENGTH_LONG).show()
    }
    private fun upload(frames : List<String>){
        try{
            ...
            RetrofitConfig.getServiceInstance().fetchSignTurPic(Frames(json)).enqueue(object :
                Callback<Output> {
