package com.example.signlang.texttovids.greek
...
import com.example.signlang.databinding.ActivityTextGreekBinding
...
class TextGreekActivity : AppCompatActivity() {
    private lateinit var binding: ActivityTextGreekBinding
    private lateinit var speechRecognizer: SpeechRecognizer
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTextGreekBinding.inflate(layoutInflater)
                ...
                override fun onResponse(call: Call<Output>, response: Response<Output>) {
                    if (response.isSuccessful) {
                        response.body()?.let {
                            ...
                            binding.videoPlayer.setMediaController(MediaController(this@TextGreekActivity))
                            binding.videoPlayer.start()
