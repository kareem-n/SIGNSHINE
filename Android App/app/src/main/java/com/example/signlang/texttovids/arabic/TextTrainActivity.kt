...
import com.example.signlang.databinding.ActivityTextTrainBinding
...
class TextTrainActivity : AppCompatActivity() {
    private lateinit var speechRecognizer: SpeechRecognizer
    private lateinit var binding: ActivityTextTrainBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTextTrainBinding.inflate(layoutInflater)
    ...
    private fun upload(word: String) {
        try {
            ...
            jsonObject.put("cat", "arabic/Train")
                ...
                override fun onResponse(call: Call<Output>, response: Response<Output>) {
                    if (response.isSuccessful) {
                        response.body()?.let {
                            ...
                            binding.videoPlayer.setMediaController(MediaController(this@TextTrainActivity))
                            binding.videoPlayer.start()
